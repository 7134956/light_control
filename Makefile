...
CFLAGS		= -Os -g -O2 -std=c99 -Wpointer-arith -Wundef -Wl,-EL -fno-inline-functions -nostdlib -mlongcalls -mtext-section-literals  -D__ets__ -DICACHE_FLASH
...
ifeq ($(esptoolmode), new)
	...
	$(ESPTOOL) -p $(ESPPORT) -b 256000 write_flash $(addr) $(FW_BASE)/upgrade/$(BIN_NAME).bin
endif
endif
endif
ifeq ($(esptoolmode), new)
